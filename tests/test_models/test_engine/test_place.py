...
class TestPlace_instatiation(unittest.TestCase):
    """
    Unittests for testing instatiation of the Place class
    """
    ...
    def test_str_representation(self):
        ...
        my_place = Place()
        my_place.id = "565566556"
        my_place.created_at = my_place.updated_at = my_date
        my_place_str = my_place.__str__()
        self.assertIn("[Place] (565566556)", my_place_str)
        self.assertIn("'id': '565566556'", my_place_str)
